...
from demos.parallel_rag_with_parsl.models.query_journey import QueryJourney, Document, StepMetadata
...
def test_journey_logger():
    ...
    # Create logger
    output_dir = "demos/parallel_rag_with_parsl/output/test_logs"
