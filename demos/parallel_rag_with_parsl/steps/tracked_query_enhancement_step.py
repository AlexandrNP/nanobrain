...
from demos.parallel_rag_with_parsl.parallel_query_enhancement_step import ParallelQueryEnhancementStep
...
class TrackedQueryEnhancementStep(ParallelQueryEnhancementStep):
    """
    Query enhancement step with journey tracking.
    
    Extends ParallelQueryEnhancementStep to log:
    - Original query
    - Enhanced query
    - Worker ID
    - Processing time
