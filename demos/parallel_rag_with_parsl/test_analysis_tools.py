...
from demos.parallel_rag_with_parsl.tools.view_journey import view_journey, list_journeys, compare_journeys
...
def test_log_analyzer():
    ...
    log_dir = "demos/parallel_rag_with_parsl/output/end_to_end_test"
    ...
    print(f"  Avg total time: {perf_stats['avg_total_time']:.3f}s")
    print(f"  Avg relevance: {perf_stats['avg_relevance_score']:.2f}")
...
def test_log_exporter(analyzer):
    ...
    output_dir = Path("demos/parallel_rag_with_parsl/output/analysis_test")
