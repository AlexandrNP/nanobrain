...
from demos.parallel_rag_with_parsl.tools.view_journey import view_journey, compare_journeys
...
async def simulate_real_workflow(logger, query_id, query):
    ...
    # Step 1: Query Enhancement (simulating ParallelQueryEnhancementStep)
    print(f"\n{'─'*80}")
...
async def main():
    ...
    output_dir = "demos/parallel_rag_with_parsl/output/full_integration_test"
