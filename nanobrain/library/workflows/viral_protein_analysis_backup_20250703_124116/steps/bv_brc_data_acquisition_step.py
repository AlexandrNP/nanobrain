    ...
    async def execute(self, input_params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                # PRIMARY OUTPUT: FASTA sequences for downstream steps
                'fasta_sequences': annotated_fasta,
                'sequence_count': len(protein_sequences),
                'sequence_headers': [line for line in annotated_fasta.split('\\n')[:20] if line.startswith('>')],  # Sample headers
                
                # PROTEIN DATA: Structured protein information
                'protein_data': {
                ...
                # GENOME DATA: For reference and statistics
                'genome_data': {
